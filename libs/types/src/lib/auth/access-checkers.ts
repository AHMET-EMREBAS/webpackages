...
export function canUpdate(userPolicy: AccessPolicy, resouceName: ResourceName) {
  return userPolicy?.[resouceName]?.update;
}

export function canDelete(userPolicy: AccessPolicy, resouceName: ResourceName) {
  return userPolicy?.[resouceName]?.delete;
}

export function canManage(userPolicy: AccessPolicy, resouceName: ResourceName) {
...
export function isRoot(userPolicy: AccessPolicy) {
  return userPolicy.Root;
}

export function isReader(userPolicy: AccessPolicy) {
  return userPolicy.Reader;
}
