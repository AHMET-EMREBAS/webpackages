...
const meta: Meta<ProductAttributeFormComponent> = {
  component: ProductAttributeFormComponent,
  title: 'ProductAttributeFormComponent',
};

export default meta;

type Story = StoryObj<ProductAttributeFormComponent>;

export const HttpForm: Story = {
  args: {
    submitButtonLabel: 'Post Form',
    formStoreName: 'ProductAttributeHttpForm',
  },
};
...
export const EventForm: Story = {
  args: {
    ...
    formStoreName: 'ProductAttributeEventForm',
  },
};
